set :application, "startoss"
set :repository, "git@github.com:itbakery/startoss.git"
set :user, "admin"
set :scm, :git
set :run_method, :run
...
role :web, "www.startoss.in.th"
role :app, "www.startoss.in.th"
role :db, "www.startoss.in.th", :primary => true
